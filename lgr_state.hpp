...
using dp_de_t =
    decltype(hpc::pressure<double>() / hpc::specific_energy<double>());
static_assert(
    std::is_same<dp_de_t, hpc::density<double>>::value,
    "dp_de should be a density");
...
class state
{
 public:
  ...
  hpc::counting_range<node_in_element_index> nodes_in_element{
      node_in_element_index(0)};
  hpc::counting_range<node_index>             nodes{node_index(0)};
  hpc::counting_range<point_index>            points{point_index(0)};
  hpc::counting_range<point_in_element_index> points_in_element{
      point_in_element_index(1)};
  ...
  hpc::device_vector<element_index, node_element_index>
      node_elements_to_elements;
  hpc::device_vector<node_in_element_index, node_element_index>
      node_elements_to_nodes_in_element;
  hpc::device_array_vector<hpc::position<double>, node_index>
      x;  // current nodal positions
  hpc::device_array_vector<hpc::displacement<double>, node_index>
      u;  // nodal displacements since previous time state
  hpc::device_array_vector<hpc::velocity<double>, node_index>
      v;  // nodal velocities
  hpc::device_vector<hpc::volume<double>, point_index>
      V;  // integration point volumes
  hpc::device_vector<hpc::basis_value<double>, point_node_index>
      N;  // values of basis functions
  hpc::device_array_vector<hpc::basis_gradient<double>, point_node_index>
      grad_N;  // gradients of basis functions
  hpc::device_array_vector<hpc::deformation_gradient<double>, point_index>
      F_total;  // deformation gradient since simulation start
  hpc::device_array_vector<hpc::stress<double>, point_index>
      sigma_full;  // Cauchy stress tensor (full)
  hpc::device_array_vector<hpc::symmetric_stress<double>, point_index>
      sigma;  // Cauchy stress tensor (symm)
  hpc::
      device_array_vector<hpc::symmetric_velocity_gradient<double>, point_index>
          symm_grad_v;  // symmetrized gradient of velocity
  hpc::device_vector<hpc::pressure<double>, point_index>
      p;  // pressure at elements (output only!)
  hpc::device_array_vector<hpc::velocity<double>, point_index>
      v_prime;  // fine-scale velocity
  hpc::device_vector<hpc::pressure<double>, point_index>
      p_prime;  // fine-scale pressure
  hpc::device_array_vector<hpc::heat_flux<double>, point_index>
      q;  // element-center heat flux
  hpc::device_vector<hpc::power<double>, point_node_index>
      W;  // work done, per element-node pair (contribution to a node's work by
          // an element)
  hpc::host_vector<
  ...
  hpc::device_vector<hpc::pressure<double>, point_index>
      K;  // (tangent/effective) bulk modulus
  hpc::host_vector<
      hpc::device_vector<hpc::pressure<double>, node_index>,
      material_index>
      K_h;  // (tangent/effective) bulk modulus at nodes
  hpc::device_vector<hpc::pressure<double>, point_index>
      G;  // (tangent/effective) shear modulus
  hpc::device_vector<hpc::speed<double>, point_index>
      c;  // sound speed / plane wave speed
  ...
  hpc::device_array_vector<hpc::force<double>, node_index>
                                                        f;  // nodal (internal) forces
  hpc::device_vector<hpc::density<double>, point_index> rho;  // element density
  hpc::device_vector<hpc::specific_energy<double>, point_index>
      e;  // element specific internal energy
  ...
  hpc::device_vector<hpc::mass<double>, node_index>
      mass;  // total lumped nodal mass
  hpc::host_vector<
      hpc::device_vector<hpc::mass<double>, node_index>,
      material_index>
      material_mass;  // per-material lumped nodal mass
  hpc::device_array_vector<hpc::acceleration<double>, node_index>
      a;  // nodal acceleration
  hpc::device_vector<hpc::length<double>, element_index>
      h_min;  // minimum characteristic element length, used for stable time
              // step
  hpc::device_vector<hpc::length<double>, element_index>
      h_art;  // characteristic element length used for artificial viscosity
  hpc::device_vector<hpc::kinematic_viscosity<double>, point_index>
      nu_art;  // artificial kinematic viscosity scalar
  hpc::device_vector<hpc::time<double>, point_index>
      element_dt;  // stable time step of each element
  hpc::host_vector<
  ...
  hpc::host_vector<
      hpc::device_vector<hpc::density<double>, node_index>,
      material_index>
      rho_h;  // nodal density
  hpc::host_vector<hpc::device_vector<dp_de_t, node_index>, material_index>
      dp_de_h;  // nodal derivative of pressure with respect to energy, at
                // constant density
  hpc::device_vector<material_index, element_index>
      material;  // element material
  hpc::device_vector<material_set, node_index>
      nodal_materials;  // nodal material set
  hpc::device_vector<hpc::adimensional<double>, element_index>
      quality;  // inverse element quality
  hpc::device_vector<hpc::length<double>, node_index>
      h_adapt;  // desired edge length
  hpc::host_vector<hpc::device_vector<node_index, int>, material_index>
      node_sets;
  hpc::host_vector<hpc::device_vector<element_index, int>, material_index>
                            element_sets;
  ...
  hpc::device_range_sum<point_node_index, point_index>
      points_to_point_nodes;  // OTM: Support for each point
  hpc::device_range_sum<node_point_index, node_index>
                                                    nodes_to_node_points;  // OTM: Influence for each node
  ...
  hpc::device_vector<point_node_index, node_point_index>
      node_points_to_point_nodes;
  hpc::device_array_vector<hpc::momentum<double>, node_index>
      lm;  // nodal linear momenta
  hpc::device_array_vector<hpc::position<double>, point_index>
      xp;  // current point positions
  ...
  hpc::device_vector<hpc::length<double>, point_index>
      h_otm;  // characteristic length, used for max-ent functions
  hpc::device_vector<point_index, point_index>
      nearest_point_neighbor;  // nearest point neighbor
  hpc::device_vector<hpc::length<double>, point_index>
      nearest_point_neighbor_dist;  // distance to nearest point neighbor
  hpc::device_vector<node_index, node_index>
      nearest_node_neighbor;  // nearest point neighbor
  hpc::device_vector<hpc::length<double>, point_index>
      nearest_node_neighbor_dist;  // distance to nearest point neighbor
  hpc::device_vector<hpc::energy_density<double>, point_node_index>
                                                                potential_density;  // Helmholtz energy density
  ...
  hpc::counting_range<material_index>                           boundaries{
      material_index(0)};  // Copied from input structure
  ...
  bool                      use_maxent_log_objective{
      false};  // Use Z or log Z as objective for maxtent functions
  bool use_maxent_line_search{false};

  // For plasticity
  hpc::device_array_vector<hpc::deformation_gradient<double>, point_index>
      Fp_total;  // plastic deformation gradient since simulation start
  hpc::device_vector<hpc::temperature<double>, point_index>
      temp;  // temperature
  hpc::device_vector<hpc::strain<double>, point_index>
      ep;  // equivalent plastic strain
  hpc::device_vector<hpc::strain_rate<double>, point_index>
      ep_dot;  // rate of equivalent plastic strain
};

...
HPC_HOST_DEVICE inline hpc::array<hpc::vector3<double>, 4>
get_subtet_coords(hpc::array<hpc::vector3<double>, 11> in, int subtet) noexcept
{
...
HPC_HOST_DEVICE inline double
get_tet_diameter(hpc::array<hpc::vector3<double>, 4> const x) noexcept
{
...
HPC_HOST_DEVICE inline double
get_length(hpc::array<hpc::vector3<double>, 10> in) noexcept
{

...
public:
  ...
  HPC_ALWAYS_INLINE HPC_HOST_DEVICE constexpr reference operator[](size_type const i) noexcept { return begin()[i]; }
  HPC_ALWAYS_INLINE HPC_HOST_DEVICE constexpr const_reference operator[](size_type const i) const noexcept { return begin()[i]; }
};

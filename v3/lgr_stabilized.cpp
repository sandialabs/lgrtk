...
HPC_NOINLINE inline void update_v_prime(input const& in, state& s, material_index const material)
{
  auto const elements_to_element_nodes = s.elements * s.nodes_in_element;
...
HPC_NOINLINE inline void update_p_h_W(state& s, material_index const material)
{
  auto const points_to_K = s.K.cbegin();
...
HPC_NOINLINE inline void update_e_h_W(state& s, material_index const material)
{
...
HPC_NOINLINE inline void update_p_h_dot(state& s, material_index const material)
{
...
HPC_NOINLINE inline void update_e_h_dot(state& s, material_index const material)
{
  auto const nodes_to_node_elements = s.nodes_to_node_elements.cbegin();
  auto const node_elements_to_elements = s.node_elements_to_elements.cbegin();
  auto const node_elements_to_nodes_in_element = s.node_elements_to_nodes_in_element.cbegin();

...
class iterator_range<Iterator, std::input_iterator_tag>
{
 ...
 public:
  ...
  resize(difference_type n) noexcept
  {
    m_end = ::hpc::advance(m_begin, n);
  }
  HPC_ALWAYS_INLINE HPC_HOST_DEVICE constexpr size_type
  size() const noexcept
  {
    return ::hpc::distance(m_begin, m_end);
  }
    ...
    : public ::hpc::impl::iterator_range<Iterator, std::input_iterator_tag>
{
 ...
 public:
  ...
  HPC_ALWAYS_INLINE HPC_HOST_DEVICE reference
  operator[](difference_type n) const noexcept
  {
    return base_type::begin()[n];
  }
};
...
class inner_iterator<Iterator, layout::right, OuterIndex, InnerIndex>
{
 ...
 public:
  ...
  HPC_ALWAYS_INLINE HPC_HOST_DEVICE inner_iterator&
                                    operator++() noexcept
  {
    ++m_begin;
    return *this;
  ...
  HPC_ALWAYS_INLINE HPC_HOST_DEVICE constexpr inner_iterator
...
class inner_iterator<Iterator, layout::left, OuterIndex, InnerIndex>
{
 ...
 public:
  ...
  HPC_ALWAYS_INLINE HPC_HOST_DEVICE constexpr inner_iterator(
      ...
      : m_begin(begin_in), m_outer_size(outer_size_in)
  {
  }
  HPC_ALWAYS_INLINE HPC_HOST_DEVICE constexpr bool
  operator==(inner_iterator const& other) const noexcept
...
class outer_iterator<Iterator, layout::right, OuterIndex, InnerIndex>
{
 ...
 public:
  ...
  operator-(outer_iterator const& other) const noexcept
  {
    return difference_type((m_begin - other.m_begin) / m_inner_size);
  }
  HPC_ALWAYS_INLINE HPC_HOST_DEVICE constexpr reference
  operator[](difference_type const n) const noexcept
  {
...
class outer_iterator<Iterator, layout::left, OuterIndex, InnerIndex>
{
 ...
 public:
  ...
  operator-(outer_iterator const& other) const noexcept
  {
    return difference_type((m_begin - other.m_begin) / InnerIndex(1));
  }
  HPC_ALWAYS_INLINE HPC_HOST_DEVICE constexpr reference
  operator[](difference_type const n) const noexcept
  {
...
class range_product<Iterator, layout::right, OuterIndex, InnerIndex>
{
 ...
 public:
  ...
  HPC_ALWAYS_INLINE HPC_HOST_DEVICE constexpr value_type
  operator[](difference_type const n) const noexcept
  {
    return begin()[n];
  }

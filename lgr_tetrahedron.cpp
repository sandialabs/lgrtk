...
void initialize_tetrahedron_V(state& s)
{
...
void initialize_tetrahedron_grad_N(state& s) {
  auto const element_nodes_to_nodes = s.elements_to_nodes.cbegin();
  auto const nodes_to_x = s.x.cbegin();
...
void update_tetrahedron_h_min_inball(input const&, state& s) {
...
void update_tetrahedron_h_art(state& s) {

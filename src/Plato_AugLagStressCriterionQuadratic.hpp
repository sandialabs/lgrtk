/*
 * Plato_AugLagStressCriterionQuadratic.hpp
 *
...
private:
    ...
    Plato::Scalar mConstraintUpperBound; /*!< stress limit/upper bound */
...
private:
    ...
    **********************************************************************************/
    void readInputs(Teuchos::ParameterList & aInputParams)
    {
        ...
        mConstraintUpperBound = tParams.get<Plato::Scalar>("Stress Limit", 1.0);
...
public:
    ...
    **********************************************************************************/
                  ...
                  Plato::Scalar aTimeStep = 0.0) const
    {
        ...
        auto tStressLimit = mConstraintUpperBound;
